...
PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream("C:/Users/Yash/OneDrive/Desktop/Javaopppractical/localpass.pdf"));
//PdfDocument pdfDocument = new PdfDocument(writer);
//System.out.println("PDF created.");  
//opens the PDF  
doc.open();  
doc.setMargins(0,0,0,0);
Image img = Image.getInstance("C:/Users/Yash/OneDrive/Desktop/mini/IR.png");
img.scaleAbsolute(95f, 95f);
doc.add(img);
Font fontSize_16 =  FontFactory.getFont(FontFactory.TIMES, 16f);
//Text text1 = new Text("Tutorialspoint"); 
//Paragraph para = new Paragraph("Train Pass"),fontSize_16 setHorizontalAlignment(Element.ALIGN_CENTER);
//doc.add(new Paragraph("Train Pass").setBold());
//String imgSrc="./IR.png";
//Image image1 = Image.getInstance("./IR.png") ;
//doc.add(image1);
...
doc.add(qrcodeImage);
//Image img1 = Image.getInstance("C:/Users/Yash/OneDrive/Desktop/mini/digital.png");
//img1.scaleAbsolute(20f, 20f);
//doc.add(img1);
//close the PDF file  
doc.close();  
//closes the writer  
